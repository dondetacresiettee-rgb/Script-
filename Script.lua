--========================================================================
-- SCRIPT V13 HORIZONTAL COMPACT: GIAO DIỆN NGANG + SONG NGỮ + MAX 100 WAYPOINTS
--========================================================================
...
WaypointLabel.Text = "Danh sách: 0 / 100 điểm\n(List: 0 / 100 points)"
...
-- ========================================================================
-- LOGIC KẾT NỐI SỰ KIỆN CLICK (ĐÃ THAY ĐỔI LIMIT THÀNH 100 ĐIỂM)
-- ========================================================================

AddPointBtn.MouseButton1Click:Connect(function()
    if #getgenv().waypoints >= 100 then return end -- Giới hạn tối đa 100 điểm
    if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
        local pos = player.Character.HumanoidRootPart.Position
        table.insert(getgenv().waypoints, pos)
        WaypointLabel.Text = "Đã lưu: " .. #getgenv().waypoints .. " / 100 điểm\n(Saved: " .. #getgenv().waypoints .. " / 100 points)"
...
LoadDataBtn.MouseButton1Click:Connect(function()
    if loadData() then
        ...
        getgenv().currentWaypointIndex = 1
        SpeedInput.Text = tostring(getgenv().flySpeed)
        WaypointLabel.Text = "Đã nhận lại: " .. #getgenv().waypoints .. " / 100 điểm\n(Loaded: " .. #getgenv().waypoints .. " / 100 points)"
...
-- HỆ THỐNG DI CHUYỂN MENU THỦ CÔNG
...
print("Đã tải thành công Menu VIP V13: Đã mở rộng tối đa giới hạn lên 100 điểm!")
                if obj:IsA("BasePart") then
                    local n = obj.Name:lower()
                    if obj:FindFirstChild("TouchInterest") and not n:find("win") and not n:find("spawn") then
                        obj:Destroy()
